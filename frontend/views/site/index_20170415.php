...
<div id="banner_tabs" class="flexslider h400">
  <ul class="slides">
      <li><a title="" href="#"><img style="background: url(/images/b1.jpg) no-repeat center;"></a></li>
      <li><a title="" href="#"><img style="background: url(/images/b1.jpg) no-repeat center;"></a></li>
  </ul>
...
<div class="w1200">
  <div class="index-title">
     ...
     <h2 style="background:#f0efe9">关于志愿<span class="line1"></span><span class="line2"></span></h2>
     <p>贵州高考志愿咨询数据平台，您身边的报考专家</p>
  </div>
  <div class="index_contact">
        <?= mb_substr($content_c[0]['content'],0,550,'utf-8')?>
  </div>

  <div class="clear"></div>
  <div class="about-more"><a href="<?=app()->urlManager->createUrl('article-' . $content_c[0]['id'])?>"  class="content">了解更多>></a></div><br /><br />
...
<div class="index-news">
  ...
  <div class="new-text">
      <div class="new-img"><a href="#"><img src="/images/58d9c88b39b28.jpg" width="100%" /></a></div>
    </div>
	<div class="new-text">
      <div class="new-img"><a href="#"><img src="/images/58d9c88b39b28.jpg" width="100%" /></a></div>
  ...
  <div class="new-right">
    <ul class="new-list" style="height:350px">
                        ...
                        <?php foreach ($content_a as $content_a):?>
                            <li><em style="float:right;"><?= $content_a['create_date']?></em><a href="<?=app()->urlManager->createUrl('article-' . $content_a['id'])?>"><?= $content_a['title']?></a></li>
                        <?php endforeach;?>
                    <?php endif;?>
