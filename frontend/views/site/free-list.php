...
<form method="post" action="#">
  <div class="w1200">
     <div class="top-phone fl">欢迎访问本网站,
                    ...
                    <?= $username?>&nbsp;&nbsp;<a href="<?=Url::toRoute('site/lsucc')?>" target="_blank">前往志贵州高考志愿咨询数据平台</a>
...
<div class="top-nav">
    <div class="w1200">
        ...
        <div class="container-fluid" style="width:100%;">
            <div class="col-md-9" style="width:60%;margin-left:14%;">
                <div class="list-group" style="margin:0 auto;">
                    <?php foreach ($schools as $school):?>
                     <div class="list-group-item" style="border: 0;">
                        <a href="#" style="color: #0F0F0F;">
                        <h4><a href=" <?=app()->urlManager->createUrl('school-' . $school['id'])?>"><?= $school['name']?></a>
                        <?php if(!empty($school['website'])):?>
                        <small class="pull-right">学校网址:<a href="<?= $school['website']?>"><?= $school['website']?></a></small>
                      <?php else:?>
