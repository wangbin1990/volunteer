...
use common\base\wechatPay\lib\dataProcess\WxPayReport;
use common\base\wechatPay\lib\dataProcess\WxPayResults;
    ...
    private static function postXmlCurl($xml, $url, $useCert = false, $second = 30)
    {
        ...
        if ($useCert == true) {
            ...
            curl_setopt($ch, CURLOPT_SSLCERT,
                'D:\phpStudy\WWW\WxpayAPI_php_v3\WxpayAPI_php_v3.0.1\cert\apiclient_cert.pem');
            curl_setopt($ch, CURLOPT_SSLKEYTYPE, 'PEM');
            curl_setopt($ch, CURLOPT_SSLKEY,
                'D:\phpStudy\WWW\WxpayAPI_php_v3\WxpayAPI_php_v3.0.1\cert\apiclient_key.pem');
        }
        //post提交方式
