        ...
        <div class="box-body">
          <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
            ...
            foreach ($models as $model) {
                ...
                echo '  <td class="view_score" data-id="'. $model->id .'">' . '<button type="button" class="btn btn-primary btn-sm">查看分数</button>'. '</td>';
			...
			<div class="modal-body">
				<div id="name_div" class="form-group">
                    <form id="add_score_form">
                        <input type="hidden" class="form-control" id="school_id" name="id"  value=""/>
	...
	<div class="modal-dialog" style="width:900px;">
		<div class="modal-content">
          ...
          <div id="batch_div" class="form-group">
              ...
              <div class="col-sm-10">
				   <select class="form-control" name="AdminSchool[batch]">
						 <option selected="selected">请选择：</option>
				  <?php foreach($cates[0]['children'] as $cate):?>
            <!-- <?php if($cate['id']==6):?>
          ...
          <div id="action_id_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <select  class="form-control" name="AdminSchool[status]">
                      <!-- <option selected="selected">请选择：</option> -->
          ...
          <div id="mold_div" class="form-group">
              ...
              <div class="col-sm-10">
				   <select  class="form-control" name="AdminSchool[mold]">
						 <option  selected = "selected">请选择：</option> -
    ...
    $.ajax({
       ...
       success: function(data){
            ...
            $.each(data, function(i, n){
                var str = '<tr>'
                +'<td><input  readonly="readonly" disabled="disabled" type="text"  class="form-control" placeholder="年份"  name="year[]" value="'+n.year+'"></td>'
                +'<td><input readonly="readonly" disabled="disabled" type="text" class="form-control" placeholder="最高分" name="high_score[]" value="'+n.high_score+'"></td>'
                +'<td><input readonly="readonly" disabled="disabled" type="text" class="form-control" placeholder="最低分" name="low_score[]" value="'+n.low_score+'"></td>'
                +'<td><input readonly="readonly" disabled="disabled" type="text" class="form-control" placeholder="省控线" name="agv_score[]" value="'+n.agv_score+'"></td>'
                +'<td><input readonly="readonly" disabled="disabled" type="text" class="form-control" placeholder="分差" name="diff_score[]" value="'+n.diff_score+'"></td>'
                +'<td><input readonly="readonly" disabled="disabled" type="text" class="form-control" placeholder="计划数" name="plan_count[]" value="'+n.plan_count+'"></td>'
                +'<td><input readonly="readonly" disabled="disabled"  type="text" class="form-control" placeholder="排位" name="rank[]" value="'+n.rank+'"></td>'
                +'<td><input disabled="disabled"  type="text" class="form-control name="batch_id[]" value="'+batch_arr[n.batch_id]+'"></td>'
                +'<td><input disabled="disabled"  type="text" class="form-control name="mold_id[]" value="'+mold_arr[n.mold_id]+'"></td>'
                +'</tr>';
    ...
    $(this).ajaxSubmit({
    	...
    	success: function(value)
    	{
        	if(value.errno == 0){
				...
				admin_tool.alert('msg_info', '添加失败', value.message);
