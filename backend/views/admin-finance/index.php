                                ...
                                <div class="col-sm-12">
                                    <table id="data_table" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="data_table_info">
                                        ...
                                        foreach ($models as $model) {
                                            ...
                                            echo '  <td>' . $model->id . '</td>';
                                            echo '  <td>' .  app()->params['charge_module_list'][$model->module_id] . '</td>';
                                            echo '  <td>' . ($model->status ? "开启" : "关闭") . '</td>';
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div id="module_id_div" class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select id="module_id" class="form-control" name="AdminFinance[module_id]">
                    ...
                    <div id="status_div" class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select id="status" class="form-control" name="AdminFinance[status]">
                                <option value="-1">请选择：</option>
                                <?php foreach(['1' => '开启', '0' => '关闭'] as $key => $module):?>
                                    <option value="<?= $key ?>"> <?= $module?></option>
                                <?php endforeach;?>
                            </select>
                        </div>
