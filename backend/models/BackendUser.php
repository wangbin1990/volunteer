...
class BackendUser extends ActiveRecord implements IdentityInterface
{
    ...
    public static function login_new($username,$password,$rememberMe)
    {
        // $adminMember = static::getMemberlist(['name' => $username]);
        $user = static::findByUsername($username);
    ...
    public static function getMemberlist($condition = [], $limit = null, $orderBy = '')
    {
