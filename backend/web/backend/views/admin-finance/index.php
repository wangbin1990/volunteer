...
$modelLabel = new \common\models\AdminFinance();
?>
        ...
        <div class="box-body">
          <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
            ...
            <?php 
              ...
              echo '<th onclick="orderby(\'module_id\', \'desc\')" '.CommonFun::sortClass($orderby, 'module_id').' tabindex="0" aria-controls="data_table" rowspan="1" colspan="1" aria-sort="ascending" >'.$modelLabel->getAttributeLabel('module_id').'</th>';
              ...
              echo '<th onclick="orderby(\'fee\', \'desc\')" '.CommonFun::sortClass($orderby, 'fee').' tabindex="0" aria-controls="data_table" rowspan="1" colspan="1" aria-sort="ascending" >'.$modelLabel->getAttributeLabel('fee').'</th>';
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
                <?php $form = ActiveForm::begin(["id" => "admin-finance-form", "class"=>"form-horizontal", "action"=>Url::toRoute("admin-finance/save")]); ?>                      
          ...
          <div id="module_id_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="module_id" name="AdminFinance[module_id]" placeholder="必填" />
              </div>
          ...
          <div id="status_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="status" name="AdminFinance[status]" placeholder="必填" />
              </div>
              <div class="clearfix"></div>
          </div>

          <div id="fee_div" class="form-group">
              <label for="fee" class="col-sm-2 control-label"><?php echo $modelLabel->getAttributeLabel("fee")?></label>
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="fee" name="AdminFinance[fee]" placeholder="必填" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="create_time_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="create_time" name="AdminFinance[create_time]" placeholder="必填" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="update_time_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="update_time" name="AdminFinance[update_time]" placeholder="必填" />
              </div>
              <div class="clearfix"></div>
          </div>
          ...
          <div id="update_user_div" class="form-group">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" id="update_user" name="AdminFinance[update_user]" placeholder="必填" />
              </div>
              <div class="clearfix"></div>
          </div>
...
function orderby(field, op){
 ...
 function searchAction(){
		$('#admin-finance-search-form').submit();
	}
 ...
 function initEditSystemModule(data, type){
	...
	if(type == "view"){
      ...
      $("#fee").attr({readonly:true,disabled:true});
	...
	$('#edit_dialog_ok').addClass('hidden');
      ...
      $("#fee").attr({readonly:false,disabled:false});
...
function initModel(id, type, fun){
	...
	$.ajax({
		   type: "GET",
		   url: "<?=Url::toRoute('admin-finance/view')?>",
		   data: {"id":id},
		   cache: false,
		   dataType:"json",
...
function deleteAction(id){
	...
	if(ids.length > 0){
		admin_tool.confirm('请确认是否删除', function(){
		    $.ajax({
				   type: "GET",
				   url: "<?=Url::toRoute('admin-finance/delete')?>",
				   data: {"ids":ids},
				   cache: false,
				   dataType:"json",
				   error: function (xmlHttpRequest, textStatus, errorThrown) {
...
$('#admin-finance-form').bind('submit', function(e) {
	e.preventDefault();
	var id = $("#id").val();
	var action = id == "" ? "<?=Url::toRoute('admin-finance/create')?>" : "<?=Url::toRoute('admin-finance/update')?>";
    $(this).ajaxSubmit({
    	type: "post",
    	dataType:"json",
    	url: action,
